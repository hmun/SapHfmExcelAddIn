...
Partial Public NotInheritable Class SapHFMAddIn
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapHFMAddIn As SapHFMAddIn
    ...
    Friend Shared Property SapHFMAddIn() As SapHFMAddIn
        Get
            Return _SapHFMAddIn
        End Get
        Set
            If (_SapHFMAddIn Is Nothing) Then
                _SapHFMAddIn = value
            Else
